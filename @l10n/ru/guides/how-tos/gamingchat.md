...
##  Использование Tisane на платформах iGaming
...
Логика модерации имён пользователей может отличаться от модерации чата. Например:  *BitcoinKing*, *Гитлер*, *голыесупермодели* и т. д. дают довольно хорошее представление о намерениях пользователя.
