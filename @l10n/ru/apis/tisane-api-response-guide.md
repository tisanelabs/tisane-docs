...
- `personal_attack` (личные нападки) - прямые оскорбления или нападки, направленные на отдельного человека. Например: случаи кибербуллинга. Примечание: Критика идей, постов или негативная тональность не является личным оскорблением. См. также: [Личные нападки](/guides/abuse/personalattack.md)
...
- `profanity` (сквернословие) — использование ненормативной лексики независимо от контекста или намерения. Обратите внимание, что расовые оскорбления не попадают в этот тип. См. также: [Ненормативная лексика](/guides/abuse/profanity.md)
- `sexual_advances` (cексуальные домогательства) - попытки, как желательные, так и нежелательные, добиться сексуальных услуг или удовлетворения. См. также: [Сексуальные домогательства](/guides/abuse/sexualadvances.md)
- `criminal_activity` (преступная деятельность) — контент, включающий попытки продать или приобрести незаконные предметы, заняться оказанием или приобретением преступных услуг, или высказывание угроз физической расправы. См. также: [Преступная деятельность](/guides/abuse/criminalactivity.md)
...
- `adult_only` (только для взрослых) - действия и темы, неприемлемые для несовершеннолетних. Например: Употребление алкоголя. См. также: [Контент только для взрослых](/guides/abuse/adultonly.md)
- `mental_issues` (проблемы с психикой) — контент, который может указывать на проблемы с психическим здоровьем, такие как мысли о самоубийстве или признаки депрессии. См. также: [Проблемы с психическим здоровьем](/guides/abuse/mental.md)
- `allegation` (обвинение) — обвинения в неправомерном преступном поведении, или деятельности, о которой обычно не распространяются. См. также: [Обвинения](/guides/abuse/allegation.md)
- `contentious` (противоречивое) — контент, который может спровоцировать эмоциональную реакцию у отдельных лиц или групп. См. также: [Противоречивый контент](/guides/abuse/contentious.md)
- `disturbing` (тревожное) - графические или тревожные описания, которые могут огорчить читателей. См. также: [Графический контент](/guides/abuse/disturbing.md)
- `no_meaningful_content` (нет осмысленного контента) - текст, не имеющий смысла. См. также: [Бессмысленный контент](/guides/abuse/nomeaningfulcontent.md)
- `data_leak` (утечка данных) - Опубликованные конфиденциальные данные. Например: пароли, идентификационные номера. См. также: [Утечки данных](/guides/abuse/dataleak.md)
- `spam` (спам) - Спам-контент. См. также: [Спам](/guides/abuse/spam.md)
- `social_hierarchy` (социальная иерархия) - попытки силового утверждения иерархии в сообществе. См. также: [Утверждение иерархии](/guides/abuse/socialhierarchy.md)
...
2. Параметр `sentiment` установлен на `true` (или опущен).
 ...
 - `reasons` (array of strings) — обоснования мнения, если таковые имеются. Например, в предложении _Завтрак был вкусным, но персонал недружелюбный_ массив `reasons` для аспекта `персонал` — это `["unfriendly"]`, а массив `reasons` для `завтрак` — это `["tasty"]`.
